...
-- - If the book is not available (status = 'no'), raise a notice and do nothing.
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Sorry, the book you requested is currently unavailable. isbn: %', p_issued_book_isbn;
    END IF;
END;
$$;
